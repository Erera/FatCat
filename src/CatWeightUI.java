...
CatWeightUI() {
    ...
    calcButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Cat kitty = new Cat((catSex.getSelectedIndex()), catSize.getSelectedIndex(), Double.parseDouble(catWeightField.getText()));

                ResultProcessing resultOutput = new ResultProcessing(kitty.weightResult(),Double.parseDouble(catWeightField.getText()));
